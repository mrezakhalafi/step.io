      ...
      <div className="w-full max-w-md bg-white p-8 rounded-3xl shadow-sm">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-sm">
              <Link href="/auth/forgot-password" className="font-medium text-yellow-500 hover:text-yellow-600">
                Forgot password?
              </Link>
            </div>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/auth/register" className="font-medium text-yellow-500 hover:text-yellow-600">
              Sign up
            </Link>
          </p>
        </div>
